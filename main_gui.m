...
for t=1:8
   %build the rectangle
   main_anchors_rect(t) = rectangle('Position', [main_pos(t, :) 33 33], 'FaceColor', 'r', 'Curvature', [1 1], 'EdgeColor', 'r');
...
for t=1:8
   ...
   single_anchor_rect(t) = rectangle('Position', [main_pos(t, :) 33 33], 'FaceColor', 'r', 'EdgeColor', 'r', 'Curvature', [1 1]);
